...
RSpec.describe 'As a visitor', type: :feature do
  ...
  describe 'When I visit the Shelter Index Page' do
    it 'Then I see a link to sort shelters by the number of adoptable pets they have' do
      visit '/shelters'

      expect(page).to have_link('Sort By Number of Adoptable Pets')
    end
  end

  describe 'When I click on the link' do
    it "I'm taken back to the Shelters Index Page where I see all of the shelters in order of their count of adoptable pets (highest to lowest)" do
      visit '/shelters'
